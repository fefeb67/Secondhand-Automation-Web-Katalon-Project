...
public class Seller_Product {
	...
	public void seller_click_the_icon_List() {
		WebUI.click(findTestObject('Dashboard Page/navlink_daftarjual'))
	}
	...
	public void seller_click_the_button_Terbitkan() {
		WebUI.scrollToElement(findTestObject('Product Info Page/button_Terbitkan 1'), 0)
		WebUI.verifyElementVisible(findTestObject('Product Info Page/button_Terbitkan 1'))
